...
interface IdeogramV3TurboInput extends ModelInput {
  prompt: string;
  aspect_ratio?: string;
  resolution?: string;
...
export class IdeogramV3TurboModel extends BaseModel {
  readonly key = 'ideogram_v3_turbo';
  readonly replicateModelPath = 'ideogram-ai/ideogram-v3-turbo';
  ...
  readonly metadata: ModelMetadata = {
    ...
    description: 'Turbo is the fastest and cheapest Ideogram v3. v3 creates images with stunning realism, creative designs, and consistent styles. Excellent typography capabilities.',
    costPerImage: 3, // $0.03
    defaultSize: '1:1',
  };

  validateInput(input: any): IdeogramV3TurboInput {
    console.log("\n🚀 IDEOGRAM-V3-TURBO INPUT VALIDATION:");
    ...
    const validated: IdeogramV3TurboInput = {
      prompt: input.prompt,
    ...
    console.log("🚀 Using Ideogram v3 Turbo - Fast, affordable, with excellent typography capabilities");
    return validated;
  }

  transformInput(input: IdeogramV3TurboInput): Record<string, any> {
    console.log("\n🔄 IDEOGRAM-V3-TURBO INPUT TRANSFORMATION:");
    ...
    console.log("📝 Ideogram v3 Turbo excels at typography and graphic design applications");
    return transformed;
  }
}